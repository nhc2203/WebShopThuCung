<%@ Page Title="" Language="C#" MasterPageFile="~/MasterThuCung.master" AutoEventWireup="true" CodeFile="Page_VongCo.aspx.cs" Inherits="VongcoWeb_Page_VongCo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:DataList ID="DataList1" runat="server" RepeatColumns="4">
        ...
        <table style="width: 100%;">
                ...
                <tr>
                    <td>
                        &nbsp;&nbsp;&nbsp;&nbsp;<a href='../VongCoWeb/ChiTietVongCo.aspx?ID=<%#Eval("MAPK")%>'>Chi Tiết</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
