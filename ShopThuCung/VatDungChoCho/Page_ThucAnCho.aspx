<%@ Page Title="" Language="C#" MasterPageFile="~/MasterThuCung.master" AutoEventWireup="true" CodeFile="Page_ThucAnCho.aspx.cs" Inherits="VatDungChoCho_Page_ThucAnCho" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:DataList ID="DataList1" runat="server" RepeatColumns="4">
        ...
        <table style="width: 100%; float:left;">
                ...
                <tr>
                    <td>
                        &nbsp;&nbsp;&nbsp;&nbsp;<a href='../ThucAnChoWeb/ChiTietThucAnCho.aspx?ID=<%#Eval("MAPK")%>'>Chi Tiết</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
