<%@ Page Title="" Language="C#" MasterPageFile="~/MasterThuCung.master" AutoEventWireup="true" CodeFile="PageLoai_Cho.aspx.cs" Inherits="PageLoai_PageLoai_Husky" %>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td style="color:black; padding-left:150px">
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("TENCHO") %>' Font-Size="30px"></asp:Label><br />
             ...
             <table>
                ...
                <tr>
                    <td colspan="2" style="color:black;  border:0.5px solid #c26; font-size:20px;">
                        <ul>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                    Khách hàng hoàn toàn an tâm khi mua chó Husky con của thương hiệu chúng tôi vì:
                    <ul>
