...
public partial class Giohang_ThongTinGioHang : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            String cmd = "select * from CHO where MACHO= '" + id.ToString() + "'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("../TrangChu/ThanhToan.aspx?");
    }
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        DataRow da = cart2.giohang.Rows[e.RowIndex];
        cart2.DeleteProduct(da);
        ...
        GridView1.DataSource = t;
        GridView1.DataBind();
        Label1.Text = cart2.truTien().ToString();
